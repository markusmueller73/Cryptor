...
EndProcedure
;--------------------------------------------------------------------------------
Procedure.s gen_pwd2( Length.l , UpperCase.l = 0 , LowerCase.l = 0 , Numbers.l = 0 , SpecialSigns.l = 0 , BeginWith.l = #BEGIN_WITH_RANDOM , OnlyValidSpecials = #True , FormatWithHyphen = #True)
